...
const benefits = [
  {
    ...
    body: 'Introduce e-commerce merchants who are looking for a clean integration layer to connect with licensed third-party financial service providers.',
    d: 'M5 13l4 4L19 7',
  },
  {
  ...
  },
  {
    ...
    body: 'You introduce merchants to powerful technology — clean APIs, integration tooling and operational software backed by an established licensed third-party provider network.',
  ...
  },
  {
    ...
    body: 'Bring your clients a software-first integration platform — engineered, observable and built for serious e-commerce operations.',
...
const steps = [
  ...
  { n: '03', title: 'Introduce merchants', body: 'Connect us to e-commerce merchants whose challenges fit the integration layer we build.' },
...
const audiences = [
  { tag: 'Consultants', title: 'Integration & e-commerce consultants', body: 'Bring clients a modern technical option that complements their existing licensed third-party providers.' },
  { tag: 'Agencies', title: 'Digital & e-commerce agencies', body: 'Add a serious integration partner to the stack you recommend to your merchant clients.' },
  ...
  { tag: 'Advisors', title: 'Independent advisors', body: 'Refer e-commerce operators looking to consolidate technical complexity across their licensed third-party provider network.' },
];

const faqs = [
  { q: 'Who is the introducer program for?', a: 'Consultants, agencies, integrators and independent advisors who work with e-commerce merchants and want to introduce them to a modern integration layer.' },
  ...
  return (
    <>
      <PageHero
        ...
        lead="Our Introducer Program is designed for consultants, agencies and integrators who work with e-commerce merchants and want to connect them with a modern technical integration layer."
      />
      ...
      <section className="section-pad">
        <div className="container">
          <div className="modules-header">
            ...
            <div className="reveal">
              <p className="lead">
                You introduce the merchant; we handle the technical conversation. A simple, transparent program for partners who want to plug their clients into a modern integration layer — backed by a licensed third-party provider network.
              </p>
            </div>
          </div>
