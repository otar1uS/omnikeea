  ...
  return (
    <>
      <PageHero
        ...
        title={<><span className="grad">Protect Payments & Reduce Risk</span></>}
        ...
        <div className="container">
          <div className="modules-header">
            <div className="reveal">
              ...
              <h2 className="h2">Secure your operations</h2>
            </div>
            <div className="reveal">
              <p className="lead">
                Utilize comprehensive risk management rules, 3D Secure workflows, and secure tokenization to protect sensitive data and prevent fraudulent transactions.
              </p>
            </div>
          </div>
