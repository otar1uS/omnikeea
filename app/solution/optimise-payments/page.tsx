  ...
  return (
    <>
      <PageHero
        ...
        title={<><span className="grad">Optimise Integration Performance</span></>}
        ...
        <div className="container">
          <div className="modules-header">
            <div className="reveal">
              ...
              <h2 className="h2">Get more from every integration</h2>
            </div>
            <div className="reveal">
              <p className="lead">
                Leverage our configurable workflow rules and retry logic to recover failed technical calls, direct traffic to the most reliable licensed third-party providers, and improve overall integration performance.
              </p>
            </div>
          </div>
