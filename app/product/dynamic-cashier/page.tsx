  ...
  return (
    <>
      <PageHero
        ...
        title={<><span className="grad">Dynamic Cashier</span></>}
        ...
        <div className="container">
          <div className="modules-header">
            <div className="reveal">
              ...
              <h2 className="h2">A smarter checkout experience</h2>
            </div>
            <div className="reveal">
              <p className="lead">
                Display the right options, in the right currency, dynamically based on the user's location and configuration profile. Improve conversion through a frictionless front-end — all options are provided and operated by your licensed third-party providers.
              </p>
            </div>
          </div>
