      ...
      <section className="section-pad">
        <div className="container">
          <div className="modules-header">
            ...
            <div className="reveal">
              <p className="lead">
                Present the right payment methods, in the right currency, dynamically based on the user's location and risk profile. Improve conversion rates by offering a frictionless front-end.
              </p>
            </div>
          </div>
