  ...
  return (
    <>
      <PageHero
        ...
        title={<><span className="grad">White Label Platform</span></>}
        ...
        <div className="container">
          <div className="modules-header">
            <div className="reveal">
              ...
              <h2 className="h2">Your brand, our technology</h2>
            </div>
            <div className="reveal">
              <p className="lead">
                Deploy a fully branded technology toolkit for your customers without the overhead of building it from scratch. We provide the software, you own the relationship — all regulated financial operations remain with your licensed third-party providers.
              </p>
            </div>
          </div>
