      ...
      <section className="section-pad">
        <div className="container">
          <div className="modules-header">
            ...
            <div className="reveal">
              <p className="lead">
                Deploy a fully branded payment gateway solution for your merchants without the overhead of building it from scratch. We provide the technology, you own the relationship.
              </p>
            </div>
          </div>
