  ...
  return (
    <>
      <PageHero
        ...
        title={<><span className="grad">Payment Orchestration</span></>}
        ...
        <div className="container">
          <div className="modules-header">
            <div className="reveal">
              ...
              <h2 className="h2">Control your payment flows</h2>
            </div>
            <div className="reveal">
              <p className="lead">
                Our orchestration engine sequences calls, applies routing rules, manages retries and surfaces operational data — giving your team a clean, observable layer over the entire provider network.
              </p>
            </div>
          </div>
